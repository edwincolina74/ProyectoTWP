...
<body>
	...
	<!-- FIN CABECERA    -->
	<div class="enlaces">
		<p><a href="atracciones.html">Atracciones Turísticas</a> >&nbsp;&nbsp;EL CONVENTO DE SANTO DOMINGO</p>
	</div>
	<br><br>
	<div class="titulos-pg">
		<h1>El Convento de Santo Domingo</h1>
		<div class="info">
	...
	<div class="container">
        <div class="image">
            <img src="imagenes/slider/convento/img-1.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/convento/img-2.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/convento/img-3.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/convento/img-4.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/convento/img-5.jpg" alt="">
        </div>
