...
<body>
	...
	<!-- FIN CABECERA    -->
	<div class="enlaces">
		<p><a href="atracciones.html">Atracciones Turísticas</a> >&nbsp;&nbsp;LAS CATABUMBAS DE SAN FRANCISO</p>
	</div>
	<br><br>
	<div class="titulos-pg">
		<h1>Las Catacumbas de San Francisco</h1>
		<div class="info">
	...
	<div class="container">
        <div class="image">
            <img src="imagenes/slider/catabumbas/img-1.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/catabumbas/img-2.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/catabumbas/img-3.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/catabumbas/img-4.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/catabumbas/img-5.jpg" alt="">
        </div>
