...
<body>
	...
	<!-- HABITACIONES Y SUITES -->
		<div class="centrado habitaciones-portada">
			<h1 class="titulo-color">HABITACIONES Y SUITES</h1> 
			<h3 class="titulo-color"> Cómodas habitaciones en Miraflores</h3>
			<p>Las habitaciones están situadas entre los pisos 2 y 14 y cuentan con una cama tamaño king o dos camas dobles, internet WiFi, Smart TV curvo de 49" con señal digital, dos líneas de teléfono con buzón de voz, reloj despertador, caja fuerte, cafetera y un minibar. Las habitaciones miden entre 28m² (92 ft) y 33 m² (108 ft).Las habitaciones están equipadas con una cama King o dos camas dobles, internet WiFi, Smart TV curvo de 49" con señal digital, dos líneas telefónicas con buzón de voz, reloj despertador, caja fuerte en la habitación, cafetera, plancha y tabla de planchar, minibar y hermosos baños de mármol blanco que incluyen bañeras de hidromasaje </p>
	...
	<div>
		<h1 class="titulo-color centrado">SERVICIOS EN LA HABITACION</h1>
	</div>
	<div  class="flex-center"><p>Las comodidades exclusivas incluyen Wi-Fi de cortesía, Smart TV curvo con señal digital, camas con pillow-top, cómodas batas, pantuflas y minibar. El servicio de habitaciones está disponible en nuestros galardonados restaurantes gourmet. </p>
	</div>
			...
			<div class="flex-col">
    			<!-- <div id="caja-1" class="alin-izq"> -->
					...
					<ul>
							<li>Internet inalámbrico de cortesía</li>
							<li>Smart TV curvo de 49" con señal digital</li>
							<li>Cafetera</li>
							<li>Plancha y tabla de planchar</li>
							<li>Minibar</li>
							<li>Camas de almohada</li>
							<li>Secador de pelo</li>
							<li>Bata de baño</li>
							<li>Aire individual, calefacción y aire acondicionado</li>
							<li>Amplia área de trabajo</li>
							<li>Mensaje de voz</li>
							<li>Caja de seguridad digital</li>
							<li>Balcones privados</li>
							<li>Periódico nacional</li>
							<li>Persianas blackout</li>
						</ul>
