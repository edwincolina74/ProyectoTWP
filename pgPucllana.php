...
<body>
	...
	<!-- FIN CABECERA    -->
	<div class="enlaces">
		<p><a href="atracciones.html">Atracciones Turísticas</a> >&nbsp;&nbsp;HUACA PUCLLANA</p>
	</div>
	<br><br>
	...
	<div class="container">
        <div class="image">
            <img src="imagenes/slider/huaca/img-1.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/huaca/img-2.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/huaca/img-3.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/huaca/img-4.jpg" alt="">
        </div>
        <div class="image">
            <img src="imagenes/slider/huaca/img-5.jpg" alt="">
        </div>
